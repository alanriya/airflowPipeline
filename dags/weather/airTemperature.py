...
from weather.urls import TEMPERATURE_URL


class AirTemperature(WeatherBase):
    ...
    def store_data(self):
        ...
        with open("/opt/airflow/files/air_temperature.csv", "w", encoding="utf-8", newline="") as file:
...
if __name__ == "__main__":
    at = AirTemperature(TEMPERATURE_URL)
    at.retrieve_data()